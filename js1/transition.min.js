! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.transition = e() : t.transition = e()
}(this, function() {
    return function(t) {
        function e(r) {
        ...
        i.defaultOptions = {
            ...
            var s = void 0,
                ...
                c = void 0,
                u = [];
            if (e.hasOwnProperty("properties") && (n = e, e = e.properties), o.isString(e)) u.push(new r(e));
            else if (o.isArray(e))
                if (o.isString(e[0]) && e[0].indexOf(" ") === -1) u.push(new r(e));
                else
                    for (a = 0; a < e.length; a++) c = e[a], !o.isArray(c) && c instanceof r || (c = new r(c)), u.push(c);
            else if ("property" in e) c = new r(e), u.push(c);
            else
                for (c in e) e.hasOwnProperty(c) && (o.isArray(e[c]) ? (c = [c].concat(e[c]), c = new r(c)) : (c = o.defaults({
                    property: c
                }, e[c]), c = new r(c)), u.push(c));
            return s = new i(u, n), s.beginTransition(t), {
            ...
            if (n = t.style[o.transitionProperty]) {
                if (r = t.style[o.transitionDuration], i = t.style[o.transitionDelay], s = t.style[o.transitionTimingFunction], u = n.split(a), l = r ? r.split(a) : ["0s"], p = i ? i.split(a) : ["0s"], s)
                    for (h = []; f = null !== c.exec(s);) h.push(f[1]);
                else h = ["ease"];
                for (d = u.length, _ = l.length, v = p.length, y = h.length, e = 0; e < d; e++) _ <= e && l.push(l[e % _]), v <= e && p.push(p[e % v]), y <= e && h.push(h[e % y])
            }
            return {
                cssProperties: u,
                durations: l,
            ...
            t.style[o.transitionProperty] = e.cssProperties.join(", "), t.style[o.transitionDuration] = e.durations.join(", "), t.style[o.transitionDelay] = e.delays.join(", "), t.style[o.transitionTimingFunction] = e.timingFunctions.join(", ")
        }, i.prototype = {
            constructor: i,
            beginTransition: function(t) {
                var e = void 0,
                    n = void 0;
                for (this.finishTransitioningPropertiesIfExist(t), e = 0; e < this.properties.length; e++) n = this.properties[e], o.isString(n.from) || o.isNumber(n.from) || (n.from = window.getComputedStyle(t, null).getPropertyValue(n.cssProperty));
                for (e = 0; e < this.properties.length; e++) n = this.properties[e], n.from == n.to ? (t.style[n.domProperty] = n.to, this.executeOnTransitionEndForProperty(n, t, !0)) : (t.style[n.domProperty] = n.from, this.toBeTransitionedPropertyNames.push(n.cssProperty), this.toBeTransitionedProperties.push(n));
                return o.isFunction(this.onBeforeChangeStyle) && this.onBeforeChangeStyle(t), 0 === this.toBeTransitionedProperties.length ? (o.isFunction(this.onAfterChangeStyle) && this.onAfterChangeStyle(t), void this.executeOnTransitionEnd(t, !0)) : (t.offsetHeight, this.addTransitionEndListener(t), void o.executeInNextEventLoop(function() {
                    var e = void 0,
                        n = void 0,
                        r = void 0;
                    if (0 !== this.toBeTransitionedProperties.length) {
                        for (e = i.getElementTransitionValues(t), n = 0; n < this.toBeTransitionedProperties.length; n++) r = this.toBeTransitionedProperties[n], e.cssProperties.push(r.cssProperty), e.durations.push(r.duration || this.duration), e.delays.push(r.delay || this.delay), e.timingFunctions.push(r.timingFunction || this.timingFunction);
                        for (this.transitioningPropertyNames = this.toBeTransitionedPropertyNames, this.transitioningProperties = this.toBeTransitionedProperties, this.toBeTransitionedPropertyNames = [], this.toBeTransitionedProperties = [], i.setElementTransitionValues(t, e), n = 0; n < this.transitioningProperties.length; n++) r = this.transitioningProperties[n], t.style[r.domProperty] = r.to;
                        o.isFunction(this.onAfterChangeStyle) && this.onAfterChangeStyle(t)
                    }
                }, this))
            },
            pause: function() {},
            ...
            handleEvent: function(t) {
                t.target === t.currentTarget && this.hasTransitioningProperty(t.propertyName) && this.finishTransitioningProperty(t.currentTarget, t.propertyName)
            },
            ...
            removeTransitioningProperty: function(t) {
                var e = void 0;
                if (e = this.transitioningPropertyNames.indexOf(t), e < 0) throw "[Transition.removeTransitioningProperty]: Transition does not have transitioning property '" + t + "'";
                this.transitioningPropertyNames.splice(e, 1), this.transitioningProperties.splice(e, 1)
            },
            ...
            removeToBeTransitionedProperty: function(t) {
                var e = void 0;
                if (e = this.toBeTransitionedPropertyNames.indexOf(t), e < 0) throw "[Transition.removeToBeTransitionedProperty]: Transition does not have toBeTransitionedProperty '" + t + "'";
                this.toBeTransitionedPropertyNames.splice(e, 1), this.toBeTransitionedProperties.splice(e, 1)
            },
            getPropertyByPropertyName: function(t) {
                var e = void 0;
                for (e = 0; e < this.properties.length; e++)
                    if (this.properties[e].cssProperty === t) return this.properties[e];
                throw "[Transition.getPropertyByPropertyName]: Transition does not have property '" + t + "'"
            },
            finishTransitioningProperty: function(t, e) {
                var n = void 0,
                    r = void 0,
                    o = void 0;
                if (this.removeTransitioningProperty(e), r = i.getElementTransitionValues(t), n = r.cssProperties.indexOf(e), n < 0) throw "[Transition.finishTransitioningProperty]: Did not find transitionProperty '" + e + "'";
                r.cssProperties.splice(n, 1), r.durations.splice(n, 1), r.delays.splice(n, 1), r.timingFunctions.splice(n, 1), i.setElementTransitionValues(t, r), o = this.getPropertyByPropertyName(e), this.executeOnTransitionEndForProperty(o, t, !0), 0 === this.transitioningProperties.length && this.removeTransitionEndListener(t, !1)
            },
            finishTransitioningPropertiesIfExist: function(t) {
                var e = void 0,
                    ...
                    c = void 0,
                    u = !1;
                if (t.hasOwnProperty("_transitions") && 0 !== t._transitions.length) {
                    for (r = i.getElementTransitionValues(t), o = t._transitions.slice(), e = 0; e < o.length; e++) {
                        for (s = o[e], a = [], c = [], n = 0; n < this.properties.length; n++) s.hasTransitioningProperty(this.properties[n].cssProperty) ? a.push(this.properties[n]) : s.hasToBeTransitionedProperty(this.properties[n].cssProperty) && c.push(this.properties[n]);
                        a.length ? (u = !0, s.allPropertiesWereFinished = !1, s.finishTransitioningProperties(t, a, r, this.beginFromCurrentValue)) : c.length && (s.allPropertiesWereFinished = !1, s.finishToBeTransitionedProperties(t, c, this.beginFromCurrentValue))
                    }
            ...
            finishTransitioningProperties: function(t, e, n, r) {
                ...
                for (i = 0; i < e.length; i++) {
                    if (s = e[i], c = s.cssProperty, this.removeTransitioningProperty(c), this.updateFromToCurrentValueIfNeeded(t, s, r), o = n.cssProperties.indexOf(c), o < 0) throw "[Transition.finishTransitioningProperties]: Did not find transitionProperty '" + c + "'";
                    n.cssProperties.splice(o, 1), n.durations.splice(o, 1), n.delays.splice(o, 1), n.timingFunctions.splice(o, 1), a = this.getPropertyByPropertyName(c), this.executeOnTransitionEndForProperty(a, t, !1)
                }
                0 === this.transitioningProperties.length && this.removeTransitionEndListener(t, !0)
            },
            finishToBeTransitionedProperties: function(t, e, n) {
                var r = void 0,
                    ...
                    s = void 0,
                    a = void 0;
                for (r = 0; r < e.length; r++) i = e[r], a = i.cssProperty, this.removeToBeTransitionedProperty(a), this.updateFromToCurrentValueIfNeeded(t, i, n), s = this.getPropertyByPropertyName(a), this.executeOnTransitionEndForProperty(s, t, !1);
                0 === this.toBeTransitionedProperties.length && (o.isFunction(this.onAfterChangeStyle) && this.onAfterChangeStyle(t), this.removeTransitionEndListener(t, !0))
            },
            updateFromToCurrentValueIfNeeded: function(t, e, n) {
                var r = o.isBoolean(e.beginFromCurrentValue);
                (r && e.beginFromCurrentValue || !r && n) && (e.from = window.getComputedStyle(t, null).getPropertyValue(e.cssProperty))
            },
            addTransitionEndListener: function(t) {
                t.hasOwnProperty("_transitions") || (t._transitions = []), t._transitions.push(this), t.addEventListener(o.transitionEndEvent, this, !1)
            },
            removeTransitionEndListener: function(t, e) {
                var n = void 0;
                if (!t.hasOwnProperty("_transitions")) throw "element does not have own _transitions property";
                if (n = t._transitions.indexOf(this), n < 0) throw "Can't remove non existing transition from an element";
                t._transitions.splice(n, 1), t.removeEventListener(o.transitionEndEvent, this, !1), this.executeOnTransitionEnd(t, e)
            },
            executeOnTransitionEndForProperty: function(t, e, n) {
                var r = void 0;
                o.isFunction(t.onTransitionEnd) && (r = t.onTransitionEnd, o.executeInNextEventLoop(function() {
                    r(e, n)
                }))
            },
            executeOnTransitionEnd: function(t, e) {
                var n = void 0;
                o.isFunction(this.onTransitionEnd) && (n = this.onTransitionEnd, e ? o.executeInNextEventLoop(function() {
                    n(t, this.allPropertiesWereFinished)
                }, this) : n(t, this.allPropertiesWereFinished)), this.resolve(this.allPropertiesWereFinished)
            }
        }, t.exports = {
        ...
        function r() {
            var t = void 0,
                ...
                n = void 0,
                r = void 0;
            for (u = [], t = 0; t < e.length; t++) n = e[t], r = n.func, n.context ? r.apply(n.context) : r()
        }
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            ...
            h = function() {
                ...
                return function(i) {
                    ...
                    for (a = i.replace(n, function(t) {
                            return t.toUpperCase()
                        }), o = 0; o < r; o++)
                        if (s = e[o] + a, "undefined" != typeof t.style[s]) return l[i] = s, s;
                    return null
                }
            }(),
            f = null !== h("transition"),
        ...
        t.exports = {
            ...
            executeInNextEventLoop: function(t, e) {
                0 === u.length && window.setTimeout(r, 0), u.push({
                    func: t,
                    context: e
                })
            },
            extend: function(t) {
                ...
                for (var e = void 0, n = void 0, r = 1, i = arguments.length; r < i; r++) {
                    e = arguments[r];
            ...
            defaults: function(t) {
                ...
                for (var e = 1, n = arguments.length; e < n; e++) {
                    var r = arguments[e];
                    for (var i in r) r.hasOwnProperty(i) && void 0 === t[i] && (t[i] = r[i])
                }
                return t
            },
            isObject: function(t) {
                ...
                return function t(e, n, r) {
                    ...
                    9: [function(t, n, r) {
                        ...
                        n.exports = function(n, r) {
                            ...
                            function P(t, e, n, r) {
                                ...
                                "unhandledRejection" === t ? et(t, n, r) || i || F(n, "Unhandled rejection ") : et(t, r)
                            }
                            ...
                            var A, V, B, I = n._getDomain,
                                ...
                                G = !(0 == L.env("BLUEBIRD_WARNINGS") || !z && !L.env("BLUEBIRD_WARNINGS")),
                                X = !(0 == L.env("BLUEBIRD_LONG_STACK_TRACES") || !z && !L.env("BLUEBIRD_LONG_STACK_TRACES")),
                                K = 0 != L.env("BLUEBIRD_W_FORGOTTEN_RETURN") && (G || !!L.env("BLUEBIRD_W_FORGOTTEN_RETURN"));
                            n.prototype.suppressUnhandledRejections = function() {
                                ...
                                if (this._isRejectionUnhandled()) {
                                    ...
                                    this._setUnhandledRejectionIsNotified(), P("unhandledRejection", V, t, this)
                                }
                                ...
                                var e = I();
                                V = "function" == typeof t ? null === e ? t : L.domainBind(e, t) : void 0
                            }, n.onUnhandledRejectionHandled = function(t) {
                                var e = I();
                                A = "function" == typeof t ? null === e ? t : L.domainBind(e, t) : void 0
                            };
                            var Z = function() {};
                            n.longStackTraces = function() {
                                ...
                                if (!st.longStackTraces && x()) {
                                    ...
                                    st.longStackTraces = !0, Z = function() {
                                        if (N.haveItemsQueued() && !st.longStackTraces) throw new Error("cannot enable long stack traces after promises have been created\n\n    See http://goo.gl/MqrFmX\n");
                                        n.prototype._captureStackTrace = t, n.prototype._attachExtraTrace = e, r.deactivateLongStackTraces(), N.enableTrampoline(), st.longStackTraces = !1
                                    }, n.prototype._captureStackTrace = d, n.prototype._attachExtraTrace = _, r.activateLongStackTraces(), N.disableTrampolineIfNecessary()
                                }
                            ...
                            var J = function() {
                                    try {
                                        ...
                                        return t.initCustomEvent("testingtheevent", !1, !0, {}), L.global.dispatchEvent(t),
                                            function(t, e) {
                            ...
                            n.config = function(t) {
                                if (t = Object(t), "longStackTraces" in t && (t.longStackTraces ? n.longStackTraces() : !t.longStackTraces && n.hasLongStackTraces() && Z()), "warnings" in t) {
                                    var e = t.warnings;
                                    st.warnings = !!e, K = st.warnings, L.isObject(e) && "wForgottenReturn" in e && (K = !!e.wForgottenReturn)
                                }
                            ...
                            var nt = h,
                                ...
                                it = /[\/<\(]([^:\/]+):(\d+):(?:\d+)\)?\s*$/;
                            L.inherits(R, Error), r.CapturedTrace = R, R.prototype.uncycle = function() {
                                var t = this._length;
                                if (!(t < 2)) {
                                ...
                                if (!t.__stackCleaned__) {
                                    ...
                                    w(r), b(r), L.notEnumerableProp(t, "stack", g(n, r)), L.notEnumerableProp(t, "__stackCleaned__", !0)
                                }
                            };
                            var ot = function() {
                                var t = /^\s*at\s*/,
                            ...
                            "undefined" != typeof console && "undefined" != typeof console.warn && (B = function(t) {
                                console.warn(t)
                            }, L.isNode && e.stderr.isTTY ? B = function(t, e) {
                                var n = e ? "[33m" : "[31m";
                                console.warn(n + t + "[0m\n")
                            } : L.isNode || "string" != typeof(new Error).stack || (B = function(t, e) {
                    ...
                    18: [function(t, e, n) {
                        ...
                        e.exports = function(e, n, r, i, o, s) {
                            function a(t, e, n, r) {
                                ...
                                var i = u();
                                this._callback = null === i ? e : l.domainBind(i, e), this._preservedValues = r === o ? new Array(this.length()) : null, this._limit = n, this._inFlight = 0, this._queue = [], f.invoke(this._asyncInit, this, void 0)
                            }
                    ...
                    22: [function(t, n, r) {
                        ...
                        n.exports = function() {
                            ...
                            return o.prototype.toString = function() {
                                ...
                                var p = u();
                                if (0 !== (50397184 & l)) {
                                    var h, f, _ = c._settlePromiseCtx;
                                    0 !== (33554432 & l) ? (f = c._rejectionHandler0, h = t) : 0 !== (16777216 & l) ? (f = c._fulfillmentHandler0, h = e, c._unsetRejectionIsUnhandled()) : (_ = c._settlePromiseLateCancellationObserver, f = new b("late cancellation observer"), c._attachExtraTrace(f), h = e), y.invoke(_, c, {
                                        handler: null === p ? h : "function" == typeof h && d.domainBind(p, h),
                                        promise: a,
                                        receiver: r,
                                        value: f
                                    })
                                ...
                                if (0 === (65536 & i)) {
                                    r._pushContext();
                                    var o;
                                    e === C ? n && "number" == typeof n.length ? o = A(t).apply(this._boundValue(), n) : (o = R, o.e = new g("cannot .spread() a non-array: " + d.classString(n))) : o = A(t).call(e, n);
                                    var s = r._popContext();
                                    i = r._bitField, 0 === (65536 & i) && (o === T ? r._reject(n) : o === R ? r._rejectCallback(o.e, !1) : (k.checkForgottenReturns(o, s, "", r, this), r._resolveCallback(o)))
                                }
                            ...
                            }, d.notEnumerableProp(o, "_makeSelfResolutionError", l), t("./method")(o, w, E, h, k), t("./bind")(o, w, E, k), t("./cancel")(o, F, h, k), t("./direct_resolve")(o), t("./synchronous_inspection")(o), t("./join")(o, F, E, w, y, u), o.Promise = o, o.version = "3.4.7", t("./map.js")(o, F, h, E, w, k), t("./call_get.js")(o), t("./using.js")(o, h, E, j, w, k), t("./timers.js")(o, w, k), t("./generators.js")(o, h, w, E, r, k), t("./nodeify.js")(o), t("./promisify.js")(o, w), t("./props.js")(o, F, E, h), t("./race.js")(o, w, E, h), t("./reduce.js")(o, F, h, E, w, k), t("./settle.js")(o, F, k), t("./some.js")(o, F, h), t("./filter.js")(o, w), t("./each.js")(o, w), t("./any.js")(o), d.toFastProperties(o), d.toFastProperties(o.prototype), c({
                                a: 1
                            }), c({
                                b: 2
                            }), c({
                                c: 3
                            }), c(1), c(function() {}), c(void 0), c(!1), c(new o(w)), k.setBounds(v.firstLineError, d.lastLineError), o
                        }
                    }, {
                        "./any.js": 1,
                        "./async": 2,
                    ...
                    24: [function(t, e, n) {
                        ...
                        e.exports = function(e, n) {
                            ...
                            function u(t, e, n, r, i) {
                                for (var o = new RegExp(E(e) + "$"), s = a(t, e, o, n), c = 0, u = s.length; c < u; c += 2) {
                                    var l = s[c],
                                        p = s[c + 1],
                                        d = l + e;
                                    if (r === F) t[d] = F(l, h, l, p, e, i);
                                        ...
                                        f.notEnumerableProp(_, "__isPromisified__", !0), t[d] = _
                                    }
                                }
                            ...
                            l.prototype.data = function() {
                                ...
                                for (var c = new f(t), p = 0; p < t; ++p) {
                                    ...
                                    if (l.isDisposer(_)) {
                                        ...
                                        var g = r(_);
                                        g instanceof e && (_ = g._then(h, null, null, {
                                            resources: c,
                                            index: p
                                        }, void 0))
                                    }
                    ...
                    36: [function(t, r, i) {
                        ...
                        var k = t("./es5"),
                            ...
                            O, R = "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof n ? n : void 0 !== this ? this : null,
                            A = function(t, e) {
                                function n() {
                        ...
                        var H = "undefined" != typeof e && "[object process]" === T(e).toLowerCase(),
        ...
        function s() {
            _ && f && (_ = !1, f.length ? d = f.concat(d) : v = -1, d.length && a())
        }
        ...
        }, n(5), e.setImmediate = setImmediate, e.clearImmediate = clearImmediate
    }, function(t, e, n) {
        (function(t, e) {
            ! function(t, n) {
                "use strict";
                ...
                if (!t.setImmediate) {
                    ...
                    m = m && m.setTimeout ? m : t, "[object process]" === {}.toString.call(t.process) ? a() : c() ? u() : t.MessageChannel ? l() : y && "onreadystatechange" in y.createElement("script") ? p() : h(), m.setImmediate = r, m.clearImmediate = i
                }
